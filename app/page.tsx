...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground font-sans selection:bg-blue-100 dark:selection:bg-blue-900">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border bg-card/80 backdrop-blur-xl shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-6">
            <div className="hidden lg:flex items-center gap-2 text-xs sm:text-sm font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/50 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border border-emerald-200/50 dark:border-emerald-800/50 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 transition-colors">
            ...
            <ThemeToggle />
            <Button size="sm" className="hidden sm:flex font-semibold text-xs sm:text-sm text-muted-foreground hover:text-foreground bg-transparent hover:bg-muted" asChild>
              <Link href="#how-it-works">Come Funziona</Link>
            </Button>
            <Button asChild size="sm" className="bg-primary hover:bg-primary/90 text-primary-foreground text-xs sm:text-sm rounded-full px-4 sm:px-6 shadow-lg hover:shadow-xl transition-all hover:scale-105">
      ...
      <main className="flex-1">
        ...
        <section className="relative py-16 sm:py-24 lg:py-40 px-4 sm:px-6 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6 sm:space-y-8 lg:space-y-10">
            ...
            <div className="inline-flex items-center justify-center">
              <span className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950/50 dark:to-blue-900/50 border border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 text-xs font-bold uppercase tracking-[0.1em] sm:tracking-[0.12em] shadow-sm hover:shadow-md transition-shadow">
                ✓ H24 • Rimini & Riccione
              </span>
            </div>
            ...
            <div className="space-y-2 sm:space-y-6">
              <BlurText
                ...
                className="text-[2.25rem] xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter text-foreground leading-[1.05] sm:leading-[0.95] px-2"
                delay={0.05}
              />
              <BlurText
            ...
            <ClientAnimationWrapper delay={0.4} duration={0.8}>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-normal tracking-tight px-2">
                La piattaforma premium per <span className="font-semibold text-foreground">Hotel e Privati</span>.<br className="hidden sm:block" />
                <span className="text-muted-foreground">Preventivi garantiti dall&apos;AI, intervento in 60 minuti.</span>
              </p>
            ...
            <ClientAnimationWrapper delay={0.6} duration={0.8}>
              <div className="pt-6 sm:pt-8 flex flex-col gap-3 sm:gap-4 sm:flex-row sm:items-center sm:justify-center">
                ...
                <div className="flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-6 lg:px-7 py-3 sm:py-4 bg-card/80 backdrop-blur-sm rounded-full shadow-md sm:shadow-lg border border-border text-xs sm:text-sm font-semibold text-foreground hover:shadow-xl transition-all">
        ...
        <section className="py-12 sm:py-16 border-y border-border bg-card overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center space-y-6 sm:space-y-8">
            <div className="space-y-1.5 sm:space-y-2">
              <p className="text-xs font-bold text-muted-foreground uppercase tracking-[0.1em] sm:tracking-[0.15em]">Trusted by</p>
              <h3 className="text-sm sm:text-base font-semibold text-muted-foreground px-2 leading-relaxed">I migliori Hotel e B&B della Riviera Romagnola scelgono NikiTuttofare</h3>
            </div>
                ...
                >
                  <div className="flex flex-col items-center gap-1.5">
                    ...
                    <div className="text-left">
                      <p className="text-xs sm:text-sm font-bold text-foreground group-hover:text-accent transition-colors whitespace-nowrap">
                        {hotel.name}
                      </p>
        ...
        <section id="how-it-works" className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 bg-background">
      ...
      {/* FOOTER PREMIUM */}
      <footer className="py-10 sm:py-12 lg:py-16 bg-card border-t border-border text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-6 sm:space-y-8">
          <div className="space-y-1.5 sm:space-y-2">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl font-semibold text-foreground px-2">
  ...
  return (
    <div className="group relative p-6 sm:p-8 lg:p-10 bg-card rounded-2xl border border-border transition-all duration-500 hover:shadow-2xl hover:shadow-slate-300/20 dark:hover:shadow-slate-900/30 hover:border-slate-300 dark:hover:border-slate-600 hover:-translate-y-2">
      ...
      <div className="mb-4 sm:mb-6 inline-flex">
        <span className="text-4xl sm:text-5xl lg:text-6xl font-black text-muted/50 group-hover:text-muted transition-colors">
          {number}
        </span>
      </div>

      {/* Icon */}
      <div className={`mb-6 sm:mb-8 inline-flex p-4 sm:p-5 rounded-2xl bg-gradient-to-br ${iconBg} shadow-lg group-hover:shadow-xl transition-all duration-500`}>
        {icon}
      </div>

      {/* Content */}
      <h3 className="text-lg sm:text-2xl font-bold text-card-foreground mb-2 sm:mb-3 group-hover:text-primary transition-colors leading-tight">
        {title}
      </h3>
      <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-4 sm:mb-6 group-hover:text-foreground transition-colors">
        {desc}
      </p>
