...
export const chatCopy = {
  ...
  confirm_summary: "Fantastico, ho raccolto tutto! Ecco il riepilogo per Nikita. Dai un'occhiata per assicurarti che sia tutto corretto:",
  confirm_action: "È tutto giusto? Se mi dai il 'sì', avviso subito Nikita e attivo il tecnico. Se vuoi cambiare qualcosa, scrivi pure 'modifica'.",
  ask_modification: "Nessun problema. Cosa vuoi che corregga? Puoi scrivere 'nome', 'indirizzo', 'telefono', 'email' o 'disponibilità'.",
