...
export const chatCopy = {
  ...
  confirm_summary: "Fantastico, ho raccolto tutto! Ecco il riepilogo per Niki. Dai un'occhiata per assicurarti che sia tutto corretto:",
  confirm_action: "È tutto giusto? Se mi dai il 'sì', avviso subito Niki e attivo il tecnico. Se vuoi cambiare qualcosa, scrivi pure 'modifica'.",
