...
CREATE POLICY "assets_update_own" ON "public"."user_assets" FOR UPDATE USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "messages_insert_hardening" ON "public"."messages" FOR INSERT WITH CHECK (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM "public"."tickets"
  WHERE (("tickets"."id" = "messages"."ticket_id") AND (("tickets"."user_id" = "auth"."uid"()) OR ("tickets"."assigned_technician_id" = "auth"."uid"())))))));



CREATE POLICY "messages_select_hardening" ON "public"."messages" FOR SELECT USING (("public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM "public"."tickets"
  WHERE (("tickets"."id" = "messages"."ticket_id") AND (("tickets"."user_id" = "auth"."uid"()) OR ("tickets"."assigned_technician_id" = "auth"."uid"()) OR ("public"."is_admin_or_technician"() AND ("tickets"."assigned_technician_id" IS NULL))))))));
...
CREATE POLICY "profiles_select_hardening" ON "public"."profiles" FOR SELECT USING ((("auth"."uid"() = "id") OR "public"."is_admin"() OR (EXISTS ( SELECT 1
   FROM "public"."tickets"
  WHERE (("tickets"."user_id" = "profiles"."id") AND ("tickets"."assigned_technician_id" = "auth"."uid"()))))));



CREATE POLICY "profiles_update_hardening" ON "public"."profiles" FOR UPDATE USING ((("auth"."uid"() = "id") OR "public"."is_admin"())) WITH CHECK ((("auth"."uid"() = "id") OR "public"."is_admin"()));



CREATE POLICY "tech_notifications_admin_all" ON "public"."technician_notifications" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "tech_tokens_admin_all" ON "public"."technician_assignment_tokens" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "tech_tokens_admin_select_all" ON "public"."technician_assignment_tokens" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "tech_tokens_select_own" ON "public"."technician_assignment_tokens" FOR SELECT TO "authenticated" USING (("used_by" = "auth"."uid"()));
...
CREATE POLICY "tickets_insert_hardening" ON "public"."tickets" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "tickets_select_hardening" ON "public"."tickets" FOR SELECT USING ((("user_id" = "auth"."uid"()) OR ("assigned_technician_id" = "auth"."uid"()) OR "public"."is_admin"() OR ("public"."is_admin_or_technician"() AND ("assigned_technician_id" IS NULL))));



CREATE POLICY "tickets_update_hardening" ON "public"."tickets" FOR UPDATE USING ((("user_id" = "auth"."uid"()) OR ("assigned_technician_id" = "auth"."uid"()) OR "public"."is_admin"()));
...
GRANT ALL ON FUNCTION "public"."accept_technician_assignment"("p_token" "text", "p_technician_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."accept_technician_assignment"("p_token" "text", "p_technician_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."accept_technician_assignment"("p_token" "text", "p_technician_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."add_loyalty_points"() TO "anon";
GRANT ALL ON FUNCTION "public"."add_loyalty_points"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_loyalty_points"() TO "service_role";



GRANT ALL ON FUNCTION "public"."generate_assignment_token"("p_ticket_id" "uuid", "p_expires_hours" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."generate_assignment_token"("p_ticket_id" "uuid", "p_expires_hours" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."generate_assignment_token"("p_ticket_id" "uuid", "p_expires_hours" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_admin_or_technician"() TO "anon";
GRANT ALL ON FUNCTION "public"."is_admin_or_technician"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_admin_or_technician"() TO "service_role";
...
GRANT ALL ON TABLE "public"."customer_assets" TO "service_role";
...
GRANT ALL ON TABLE "public"."leads_recovery" TO "anon";
GRANT ALL ON TABLE "public"."leads_recovery" TO "authenticated";
GRANT ALL ON TABLE "public"."leads_recovery" TO "service_role";
...
GRANT ALL ON TABLE "public"."orphan_sessions_view" TO "service_role";
GRANT SELECT ON TABLE "public"."orphan_sessions_view" TO "authenticated";
...
GRANT ALL ON TABLE "public"."technician_assignment_tokens" TO "anon";
GRANT ALL ON TABLE "public"."technician_assignment_tokens" TO "authenticated";
GRANT ALL ON TABLE "public"."technician_assignment_tokens" TO "service_role";



GRANT ALL ON TABLE "public"."technician_notifications" TO "anon";
GRANT ALL ON TABLE "public"."technician_notifications" TO "authenticated";
