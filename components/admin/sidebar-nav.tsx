...
export function SidebarNav() {
    const navItems = [
        ...
        { icon: Users, label: 'Tecnici', active: false },
    ...
    return (
        <div className="flex flex-col items-center py-6 w-full h-full gap-6">
            {/* Brand Icon */}
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-cyan-500 flex items-center justify-center shadow-lg shadow-blue-500/20 mb-4">
                        ...
                        <Tooltip key={item.label}>
                            <TooltipTrigger asChild>
                                <Button
                                    variant="ghost"
                                    size="icon"
                                    className={`w-12 h-12 rounded-xl transition-all duration-200 ${item.active
            ...
            <div className="mt-auto px-2">
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button variant="ghost" size="icon" className="w-12 h-12 rounded-xl text-slate-500 hover:text-red-400 hover:bg-red-900/10">
